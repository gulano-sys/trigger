  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "dark-100": "#0a0a0a", // Slightly lighter
        "dark-200": "#121212", // Card bg
        "dark-300": "#1e1e1e", // Border/Input
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      backgroundImage: {
        "white-gradient": "linear-gradient(135deg, rgba(255, 255, 255, 0.2) 0%, rgba(255, 255, 255, 0.05) 100%)",
